...
<table class="table">
  <thead>
    <tr>
      ...
      <th> <form:input path="description" type="text" style="width:500px; "/> </th>
     </tr>
     <tr>
     <th scope="col"><form:label path="price"> Price:</form:label>
      ...
      <th> <form:input path="price" type="number" style="width:500px; " /> </th>
  </tr>
 ...
 <input type="submit" value="Add Product"  class="btn btn-primary" class="submit" style="margin-bottom:30px; margin-left:30px;" />
