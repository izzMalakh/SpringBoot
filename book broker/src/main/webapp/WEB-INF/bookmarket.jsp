...
<p>Hello <c:out value="${user.firstName}"></c:out>. Welcome to</p>
<a href="/">Back to shelves</a>
		...
		<c:forEach var="book" items="${books}">
			<tr>
				...
				<c:if test = "${book.user.id==user.id}">
			       <td><a href="/edit/book/${book.id}">edit</a> <a href="/book/delete/${book.id}">delete</a></td>
			    </c:if>
				<c:if test = "${book.user.id!=user.id}">
